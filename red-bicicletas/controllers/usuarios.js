...
module.exports = {
    ...
    update_get: function(req,res,next){
        Usuario.findById(req.params.id,(err,usuarios)=>{
            res.render('usuarios/update',{errors:{},usuario:usuarios});
        });
    },
    ...
    create: function(req,res,next){
        ...
        {
            res.render('usuarios/create',{errors:{confirm_password:{message:'No coincide con el password'}},usuario:new Usuario({nombre:req.body.nombre,email:req.body.email})});
            return;
        }
